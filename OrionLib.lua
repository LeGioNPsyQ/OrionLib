...
local OrionLib = {
    ...
    DarkRed = {
			...
			Second = Color3.fromRGB(255, 32, 32),
			Stroke = Color3.fromRGB(60, 255, 60),
			Divider = Color3.fromRGB(60, 60, 255),
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "DevilNetWork"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "DevilNetWork"
